      ...
      <section className="pt-24 w-full overflow-hidden">
        <div className="relative w-[100vw] md:w-[min(100vw,1600px)] mx-auto min-h-[65vh] md:min-h-[70vh] pb-16 md:pb-28">
          ...
          <div className="relative z-10 flex h-full w-full items-center justify-center">
            <div className="w-full max-w-[1240px] px-6 md:px-12 md:[padding-inline:calc(var(--spacing)*25)] flex flex-col-reverse md:flex-row items-center md:items-center justify-between gap-4 md:gap-8">
              ...
              <div className="relative w-[78vw] sm:w-[58vw] md:w-[36vw] lg:w-[32vw] max-w-[560px] flex justify-center md:justify-end overflow-visible md:translate-y-[5%]">
